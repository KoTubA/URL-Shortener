          ...
          <button type="button" class="main-btn main-btn-add">
            <div class="add-btn">
              <svg width="11" height="11" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.313 10.023v-3.71h3.71v-2.58h-3.71V.023h-2.58v3.71H.023v2.58h3.71v3.71z" fill="#2acfcf">
                </path>
              </svg>
            </div>
            <div class="add-info">
    ...
    <section class="add-link no-animation">
      <form class="form-system form-panel" method="POST" id="add-link">
        ...
        <div class="form-fileds">
          ...
          <input class="form-control form-control-add" type="text" name="long-url" autocorrect="off">
          <span class="error-message data-error-add"></span>
        </div>
        <div class="form-action-buttons">
          <button type="button" class="main-btn form-btn panel-btn no-fill-btn add-link-disable">Discard</button>
