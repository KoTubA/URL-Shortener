    ...
    <main class="main">
        <section class="form">
            <div class="form-cnt">
                ...
                <p class="form-description">Already have an account? <a href="sign_in" class="main-link">Login in</a>
                </p>
                ...
                <div class="terms-and-conditions">
                    ...
                    <span>Shortly's <a href="#" class="main-link">Terms of Service</a> and <a href="#"
                            class="main-link">Privacy
                            Policy.</a></span>
                </div>
            </div>
        </section>
